...
import (
	...
	missv1 "github.com/douyu/proto/gen/go/api/hw/v1"
...
// HwSayHello provides a mock function with given fields: ctx, req
func (_m *MockExampleInterface) HwSayHello(ctx context.Context, req *missv1.SayHelloRequest) (*missv1.SayHelloResponse, error) {
	ret := _m.Called(ctx, req)

	var r0 *missv1.SayHelloResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *missv1.SayHelloRequest) (*missv1.SayHelloResponse, error)); ok {
		return rf(ctx, req)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *missv1.SayHelloRequest) *missv1.SayHelloResponse); ok {
		r0 = rf(ctx, req)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*missv1.SayHelloResponse)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *missv1.SayHelloRequest) error); ok {
		r1 = rf(ctx, req)
	} else {
		r1 = ret.Error(1)
	}
